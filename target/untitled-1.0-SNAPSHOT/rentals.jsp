...
<div class="container mx-auto p-6">
  ...
  <!-- Debugging Output -->
  <p class="text-gray-600 mb-4">User: ${sessionScope.user.username}, Is Admin: ${sessionScope.isAdmin}, Rentals Loaded: ${rentals.size()}</p>
  <c:if test="${empty rentals}">
    <p class="text-gray-600 mb-4">No rental records found.</p>
  </c:if>
